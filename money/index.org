...
#+name: prices
#+begin_src ledger :eval never
  P 10/25/2023 00:00:00 VTSAX $101.2200
  P 10/25/2023 00:00:00 VTIAX $27.7300
  P 10/25/2023 00:00:00 FSPSX $42.6100
  P 10/25/2023 00:00:00 FXAIX $146.4500
...
** Budget
*** This Month
#+begin_src ledger :noweb yes :cmdline budget ^Expenses -p "this month" :exports results
  <<opening_balance>>
  <<budget>>
  <<transactions>>
#+end_src
#+RESULTS:
#+begin_example
    $ 953.97   $ 2,247.00  $ -1,293.03   42%  Expenses
    $ 460.61     $ 300.00     $ 160.61  154%    Food
    $ 102.16     $ 100.00       $ 2.16  102%      Fast Food
           0     $ 100.00    $ -100.00     0      Groceries
    $ 358.45     $ 100.00     $ 258.45  358%      Snacks
    ...
    $ 185.71     $ 246.00     $ -60.29   75%    RE:Cottage:Utilities
    $ 150.65      $ 50.00     $ 100.65  301%    Transportation:Gas
------------ ------------ ------------ -----
    $ 953.97   $ 2,247.00  $ -1,293.03   42%
#+end_example
*** Last month
...
#+RESULTS:
#+begin_example
  $ 4,561.81   $ 2,247.00   $ 2,314.81  203%  Expenses
  ...
  $ 2,818.90   $ 1,410.00   $ 1,408.90  200%      Rent
    $ 310.00     $ 216.00      $ 94.00  144%      Utilities
     $ 35.00      $ 25.00      $ 10.00  140%    Personal:Communication
    $ 421.99     $ 246.00     $ 175.99  172%    RE:Cottage:Utilities
     $ 49.55      $ 50.00      $ -0.45   99%    Transportation:Gas
------------ ------------ ------------ -----
  $ 4,561.81   $ 2,247.00   $ 2,314.81  203%
#+end_example
** Net Worth
*** Assets
...
October 01 2023     Expenses:Food:Fast Food               $ 102.16
October 01 2023     Expenses:Food:Snacks                  $ 358.45
...
October 01 2023     Expenses:Personal:Household           $ 208.17
...
October 01 2023     Expenses:Transportation:Biking        $ 30.48
