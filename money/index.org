...
** Spending
*** Savings Rate
#+begin_src python :var tr=transactions :noweb yes :exports results :results verbatim
  import re

  ledger_output = tr

  # Define a function to extract amounts from ledger lines
  ...
  lines = ledger_output.strip().split('\n')
  expenses = 0.0
  income = 0.0
  taxes = 0.0
  ...
  # Calculate take-home income and savings rate excluding taxes
