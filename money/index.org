...
#+name: prices
#+begin_src ledger :eval never
  P 04/02/2024 00:00:00 VTSAX $126.6000
  P 04/02/2024 00:00:00 VTIAX $32.3600
  P 04/02/2024 00:00:00 FSPSX $50.0900
  P 04/02/2024 00:00:00 FXAIX $182.9500
  P 04/02/2024 00:00:00 CONDO $250,000.00
  P 04/02/2024 00:00:00 COTTA $450,000.00
  P 04/02/2024 00:00:00 STRIP $26.00
#+end_src
** Transactions
#+name: transactions
#+begin_src ledger :eval never
  ...
  2024-04-09 * Sell Condo
      Assets:RE:Condo                             -1.0 CONDO @ $ 265,000.00
      Expenses:RE:Condo:Sale               $ 12,985.00
      Expenses:RE:Condo:Sale                  $ 500.00
...
#+begin_example
       ...
       3,742.0 STRIP      RSU
        ...
        $ 232,676.48    Savings:UFB
       $ -342,709.60  Liabilities
            $ -45.54    Credit Card:Covantage
       $ -342,664.06    RE:Cottage:Mortgage
--------------------
       $ -109,886.32
           1.0 COTTA
       448.938 FSPSX
...
#+begin_example
         $ 15,790.20  Expenses
          ...
          $ 1,537.50      Rent
            $ 202.00      Utilities
             $ 30.00    Personal:Communication
         $ 13,982.85    RE
         $ 13,485.00      Condo:Sale
            $ 497.85      Cottage
            $ 120.00        Cleaning
            $ 377.85        Utilities
--------------------
...
#+begin_example
         ...
         $ 13,225.01      Federal
          $ 2,794.86      Illinois
            $ 818.71      Medicare
          $ 3,500.65      Social Security
            $ 180.46    Transportation
             $ 45.38      Biking
             $ 76.52      Driving
             $ 56.52        Gas
             $ 20.00        Tolls
...
#+end_example
*** Monthly Spending
#+begin_src ledger :cmdline reg ^Expenses and not ^Expenses:Taxes and not ^Expenses:RE:.*:Sale --cleared -MnA --sort date --format "%-20(format_date(date, '%B %Y')) %(amount)\n" :noweb yes :exports results
  <<opening_balance>>
  <<transactions>>
#+end_src
#+results:
