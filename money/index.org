...
#+name: prices
#+begin_src ledger :eval never
  P 02/26/2024 00:00:00 VTSAX $122.6600
  P 02/26/2024 00:00:00 VTIAX $31.6500
  P 02/26/2024 00:00:00 FSPSX $48.6400
  P 02/26/2024 00:00:00 FXAIX $176.9300
  P 02/26/2024 00:00:00 CONDO $250,000.00
  P 02/26/2024 00:00:00 COTTA $450,000.00
#+end_src
...
#+RESULTS:
#+begin_example
  $ 2,850.22   $ 1,900.14     $ 950.08  150%  Assets:Investments:401K:Cash
 $ 22,544.76   $ 8,577.40  $ 13,967.36  263%  Expenses
    $ 551.22     $ 323.07     $ 228.15  171%    Food
    $ 287.59     $ 100.00     $ 187.59  288%      Fast Food
    $ 166.36     $ 123.07      $ 43.29  135%      Groceries
     $ 97.27     $ 100.00      $ -2.73   97%      Snacks
    $ 839.50   $ 1,626.00    $ -786.50   52%    Housing
    $ 707.50   $ 1,410.00    $ -702.50   50%      Rent
    $ 132.00     $ 216.00     $ -84.00   61%      Utilities
    $ 144.36      $ 25.00     $ 119.36  577%    Personal:Communication
  $ 5,186.73   $ 3,003.33   $ 2,183.40  173%    RE
  $ 3,240.33     $ 892.34   $ 2,347.99  363%      Condo
    $ 139.67     $ 132.34       $ 7.33  106%        HOA
           0      $ 50.00     $ -50.00     0        Insurance
    $ 272.63     $ 260.00      $ 12.63  105%        Interest
  $ 2,828.03     $ 450.00   $ 2,378.03  628%        Taxes
  $ 1,946.40   $ 2,110.99    $ -164.59   92%      Cottage
    $ 864.60     $ 865.00      $ -0.40  100%        Escrow
  $ 1,006.81   $ 1,000.00       $ 6.81  101%        Interest
     $ 74.99     $ 245.99    $ -171.00   30%        Utilities
           0   $ 3,300.00  $ -3,300.00     0    Taxes
           0     $ 100.00    $ -100.00     0    Transportation
$ -52,026.52 $ -13,917.54 $ -38,108.98  374%  Income
 $ -1,250.00  $ -1,250.00            0  100%    RE:Condo
$ -50,776.52 $ -12,667.54 $ -38,108.98  401%    Stripe
  $ 1,677.06   $ 3,440.00  $ -1,762.94   49%  Liabilities:RE
  $ 1,042.61   $ 2,800.00  $ -1,757.39   37%    Condo:Mortgage
    $ 634.45     $ 640.00      $ -5.55   99%    Cottage:Mortgage
------------ ------------ ------------ -----
$ -24,954.48            0 $ -24,954.48     0
#+end_example
** Net Worth
*** Assets
...
#+begin_example
       ...
       3,742.0 STRIP      RSU
           ...
           1.0 CONDO      Condo
           1.0 COTTA      Cottage
       $ -388,033.03  Liabilities
           $ -637.56    Credit Card:RipCo
       $ -387,395.47    RE
        $ -42,838.52      Condo:Mortgage
       $ -344,556.95      Cottage:Mortgage
--------------------
       $ -383,672.25
           1.0 CONDO
           1.0 COTTA
...
** Spending
*** This Month Spending
#+begin_src ledger :cmdline bal ^Expenses --period "this month" :noweb yes :exports results
  <<opening_balance>>
  <<transactions>>
#+end_src
#+results:
...
#+end_example
*** Last Month Spending
#+begin_src ledger :cmdline bal ^Expenses --period "last month" :noweb yes :exports results
  <<opening_balance>>
  <<transactions>>
#+end_src
#+results:
#+begin_example
         $ 12,839.99  Expenses
          ...
          $ 2,261.77      Federal
            $ 632.46      Illinois
            $ 185.27      Medicare
            $ 792.18      Social Security
            $ 687.73    Transportation
             $ 26.78      Biking
            $ 652.97      Driving
            $ 174.81        Gas
            $ 428.82        Repairs
...
*** Monthly Spending
#+begin_src ledger :cmdline reg ^Expenses and not ^Expenses:Taxes -MnA --sort date --format "%-20(format_date(date, '%B %Y')) %(amount)\n" :noweb yes :exports results
  <<opening_balance>>
  <<transactions>>
#+end_src
#+results:
